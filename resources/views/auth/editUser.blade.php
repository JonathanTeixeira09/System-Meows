    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card shadow mb-4">
            ...
            <div
                ...
                <h6 class="m-0 font-weight-bold text-primary">Editando Usuário - {{$users->profissional->nome}}</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                <div class="chart-area">
                    <!-- Formulario -->
                    <form class="row g-3" action="{{route('editarusuario.update', $users->id)}}" method="POST" name="formCadastroUser"
...
{{--                                            @endforeach--}}
{{--                                        </datalist>--}}
                                        <input type="hidden" name="nome_profissional" id="nome_profissional"
                                               value="{{ $users->profissional->nome }}">
                                        <input type="hidden" name="profissional_id" id="profissional_id"
                                               value="{{ $users->profissional->id }}">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        >
                                            ...
                                            <option value="profissional" {{ $users->role == 'profissional' ? 'selected' : '' }}>
                                                Profissional
                                            </option>
                                            <option
                                                value="superadmin" {{ $users->role == 'superadmin' ? 'selected' : '' }}>
                                                Super Administrador
                                            </option>
                                        </select>
                                        @error('permissao')
