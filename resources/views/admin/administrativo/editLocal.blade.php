            ...
            <div class="card-body">
                <div class="chart-area">
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Form -->
                            <form class="row g-2" action="{{ isset($local) ? route('locais.update', $local->id) : route('locais.store') }}" method="POST" name="formCadastro">
                                @csrf
                                @if(isset($local))
                                    @method('PUT')
                                @endif
                                        ...
                                        @foreach ($locals as $localItem)
                                            <tr>
                                                ...
                                                <td data-title="Ações" style='text-align:right;'>
                                                    <a href="{{ route('locais.edit', $localItem->id) }}">
