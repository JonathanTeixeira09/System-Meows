    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="chart-area">
                    <!-- Formulario -->
                    <form class="row g-3" action="{{ isset($profissional) ? route('editarprofissional.update', $profissional->id) : route('cadastroprofissional.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
